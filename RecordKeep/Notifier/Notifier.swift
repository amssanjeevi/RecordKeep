...
class Notifier: UIViewController {
    ...
    func showActivityIndicator(title: String) {
        ...
        backGround.applyCornerRadius()
        backGround.applyViewBorder()
    ...
    func addScreenOverlay() -> UIView {
        if let rootView = UIApplication.shared.keyWindow?.rootViewController?.view {
            if let overlay = rootView.viewWithTag(3000) {
                ...
                overlay.backgroundColor = Constants.Color.Overlay
                overlay.tag = 3000
    ...
    func getBackgroundView() -> UIView {
        ...
        backGroundView.backgroundColor = Constants.Color.White
